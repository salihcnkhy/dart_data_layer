...
import 'package:data_layer_base/data_layer_base.dart';
...
void main() {
  ...
  test('success response', () async {
    ...
    final request = SignInRequest(email: "test@test.com", password: "123456");
  ...
  test('failed response', () async {
    NetworkLayer.baseUrl = "https://hesabinibil.azurewebsites.net/api";
    final request = SignInRequest(email: "test@test.com", password: "");
    final result = await repository.trySignIn(request);
